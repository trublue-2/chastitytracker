...
export const viewport: Viewport = {
  ...
  initialScale: 1,
  viewportFit: "cover",
  // Der Grund der Vorgabewelt `sub-open` — dieselbe Farbe, die `:root` trägt. Alle drei Welten
  // sind fast schwarz; ein Wert für alle ist deshalb kein Kompromiss, sondern genügt.
  themeColor: "#0b0609",
};
...
export default async function RootLayout({
  ...
  return (
    // KEIN `suppressHydrationWarning` mehr. Es stand hier, weil ein Inline-Skript `data-theme`
    // VOR der Hydration ans Wurzelelement schrieb — der Server konnte den Wert nicht kennen, also
    // wich das gerenderte Attribut planmässig ab. `ThemeRootSync` schreibt jetzt in einem Effekt,
    // also NACH der Hydration: es gibt keine Abweichung mehr zu unterdrücken. Stehen zu bleiben
    // wäre nicht folgenlos — die Unterdrückung verschluckt auch echte Abweichungen an diesem
    // Element, etwa an `lang`, wo sich ein Fehler beim Sprach-Cookie melden würde.
    <html lang={locale}>
      <head>
