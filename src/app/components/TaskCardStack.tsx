 ...
 */
export default function TaskCardStack({ children, defaultCollapsed, titleKey = "currentTitle" }: { children: ReactNode; defaultCollapsed?: boolean; titleKey?: string }) {
  ...
  return (
    <Section className={blockInsetCls} title={t(titleKey, { count: items.length })} defaultCollapsed={defaultCollapsed}>
