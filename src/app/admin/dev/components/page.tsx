        ...
        <Section title="LockRequestBanner" description="Verschluss-Anforderung + Sperrzeit.">
          <ThemePair>
            <div className="flex flex-col gap-3">
              ...
              <LockRequestBanner variant="compact" colorScheme="request" label="Verschluss angefordert" untilLabel="bis" endsAt={inFuture} locale="de-CH" />
              <p className="text-xs text-foreground-faint font-mono">lockPeriod — compact</p>
              <LockRequestBanner variant="compact" colorScheme="sperrzeit" label="Gesperrt" untilLabel="bis" endsAt={inFuture} locale="de-CH" />
