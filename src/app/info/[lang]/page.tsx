  ...
  de: {
    ...
    sections: [
      ...
      },
      {
        ...
        iconColor: "text-indigo-600",
        title: "Admin-Bereich",
        description: "Admins verwalten alle Benutzer, fordern Kontrollen an und definieren Trainingsziele. Eine zentrale Übersicht zeigt den Status aller Benutzer auf einen Blick.",
        flip: false,
        shots: [
          ...
          { src: "/screenshots/info/09-vorgaben.png", alt: "Admin – Trainingsziele" },
        ],
        features: [
          ...
          { icon: BarChart2, color: "text-gray-400", text: "Trainingsziele: Mindesttrage­zeiten pro Tag, Woche und Monat definieren" },
        ],
      },
    ],
    cta: {
