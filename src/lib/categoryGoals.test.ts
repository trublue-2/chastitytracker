...
describe("buildCategoryWearGoals — Tages- und Wochengrenze in der Zeitzone der Sub", () => {
  const CATEGORY = { id: "c1", name: "Plug", color: "#fff", icon: "plug", deviceCount: 1, isBuiltIn: false, trackingEnabled: true };
  ...
  const entries: SegmentEntry[] = [
    { id: "w1", type: "WEAR_BEGIN", startTime: new Date("2026-07-01T00:00:00Z"), boltConfirmedAt: null, openAwaitsBolt: false, device: DEVICE },
  ];
