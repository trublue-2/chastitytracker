...
//
// Ton: knappe Referenz, kein Fliesstext. Beschreibt den AKTUELLEN Vertrag der Felder — keine Bug-/
// Änderungs-Historie (die steht im Changelog/git). Beim Bearbeiten kurz und faktisch halten.

export const MCP_MODEL_DOC = `# Tracker-Modell — Referenz für den MCP-Keyholder
