 ...
 *  get_session, damit der Enum überall ok/wrong/missing/not_checked bleibt. */
export function mcpDeviceCheckStatus(raw: DeviceCheckStatus | null): "ok" | "wrong" | "missing" | "not_checked" {
