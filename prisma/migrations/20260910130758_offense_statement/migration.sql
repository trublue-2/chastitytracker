...
CREATE TABLE "OffenseStatement" (
    ...
    CONSTRAINT "OffenseStatement_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "OffenseStatement_refId_key" ON "OffenseStatement"("refId");

-- CreateIndex
CREATE INDEX "OffenseStatement_userId_idx" ON "OffenseStatement"("userId");
