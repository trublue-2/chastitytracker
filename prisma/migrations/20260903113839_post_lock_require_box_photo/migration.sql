...
CREATE TABLE "new_KontrollAnforderung" (
    ...
    "requireBoxPhoto" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_KontrollAnforderung" ("auto", "autoMarkedEntryId", "autoMarkedRemovedAt", "benachrichtigtAt", "benachrichtigtReminderAt", "categoryId", "cleaningRelock", "code", "createdAt", "createdBy", "deadline", "deviceId", "entryId", "fulfilledAt", "id", "kommentar", "postLock", "userId", "wirksamAb", "withdrawnAt") SELECT "auto", "autoMarkedEntryId", "autoMarkedRemovedAt", "benachrichtigtAt", "benachrichtigtReminderAt", "categoryId", "cleaningRelock", "code", "createdAt", "createdBy", "deadline", "deviceId", "entryId", "fulfilledAt", "id", "kommentar", "postLock", "userId", "wirksamAb", "withdrawnAt" FROM "KontrollAnforderung";
