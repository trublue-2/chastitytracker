...
| **Verschluss-Anforderung** | Frist zum Einschliessen · `minDurationHours` = Mindest-Tragedauer **ab dem tatsächlichen Verschluss** · `lockEndsAt` = festes Ende · `lockIndefinite` = ohne Ende · bestimmtes Gerät · **terminierbar** | nur der KG, keine anderen Kategorien |
