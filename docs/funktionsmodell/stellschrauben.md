...
| `OrgasmusAnforderung.endetAt` | DateTime | (keiner) | je Direktive | Ende des Fensters. Danach ist eine ANWEISUNG versäumt. | Keyholder (UI), Keyholder (MCP) | Orgasmus, Strafbuch | — |
