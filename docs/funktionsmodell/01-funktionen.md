...
| **Darstellung einstellen** | Sprache, Startseite und das Ausblenden des eigenen Trackers. | Sub | App (Träger) | `/api/settings/locale` `/api/settings/start-page` `/api/settings/hide-own-tracker` |
