...
| **Gewicht eintragen und Ziel setzen (KI)** | Eine Messung je Kalendertag nachtragen und das Zielgewicht setzen oder zurücknehmen. <br>*Ihr Ziel gilt, seines bleibt sichtbar — dieselbe Auflösung wie in der Oberfläche. Der dryRun warnt, wenn die Zahl unter BMI 18,5 führt. Ihr Eintrag braucht keinen Foto-Beleg.* | Keyholder (MCP) | MCP | `log_weight` `set_weight_target` |
